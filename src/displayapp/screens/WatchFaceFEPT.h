...
namespace Pinetime {
  ...
  namespace Applications {
    ...
    template <>
    struct WatchFaceTraits<WatchFace::FEPT> {
      static constexpr WatchFace watchFace = WatchFace::FEPT;
      static constexpr const char* name = "FEPT face";

      static Screens::Screen* Create(AppControllers& controllers) {
        return new Screens::WatchFaceFEPT(controllers.dateTimeController,
